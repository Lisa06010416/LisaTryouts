...
This project is for **quick testing and validation of ideas**.  
Each folder is an independent experiment. You can refer to the corresponding experiment's README.md for a quick understanding and instructions on how to run the experiment.
